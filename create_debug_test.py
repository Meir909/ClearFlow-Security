...
# Create a small test dataset with proper numeric types
data = {
...
df.to_csv('debug_test_data.csv', index=False)
print("Test file 'debug_test_data.csv' created successfully!")
print("\nData preview:")
print(df.head())
print("\nData types:")
print(df.dtypes)